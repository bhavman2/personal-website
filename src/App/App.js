...
class App extends Component {
  ...
  render() {
    return (
      <div className="App">
        <Jumbotron>
          <Image src="https://s3-us-west-1.amazonaws.com/bhavik-personal-website/headshot2.jpg" roundedCircle />
          <br />
          <h1>Hi, I'm Bhavik</h1>
          <h5>Software Engineer && Problem Solver</h5>
          <h5>Los Angeles, CA</h5>
          {this.state.quotes.length !== 0 && <Carousel className="quote-ctn">
          ...
          <div className="media-ctn">
            ...
            <a title="LinkedIn" href="https://www.linkedin.com/in/bhavman2/" target="_blank" rel="noopener noreferrer"><Icon name="linkedin" height={50} width={50} /></a>
            <a title="GitHub" href="https://github.com/bhavman2" target="_blank" rel="noopener noreferrer"><Icon name="github" height={50} width={50} /></a>
          </div>
        </Jumbotron>
